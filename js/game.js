...
function Level(config,isIntro){
	...
	self.player = new Astrid(config.player,self);
...
function Astrid(config,level){
	...
	self.draw = function(ctx){
		...
		ctx.drawImage(images.Astrid,-25,-100,80,100);
		ctx.restore();
...
window.onload = function(){
	...
	addAsset("Astrid","assets/aio.png");
	...
	addSound("jazz","audio/nahpaigonvday.mp3");
...
function iHeartYou(){
	...
	if(window.location.hash){
		...
		vtext.textContent = "Sincerely, Astrid <3";
	}
...
// 		yourLink.value = "http:/githuub.com/astridisout/";
// 	}else{
// 		yourLink.value = "http:/githuub.com/astridisout/#"+encodeURIComponent(encryptString(yourMessage.value));
// 	}
// };
